...
import com.colbycoapps.med_standards.databinding.FragmentAirforceBinding
...
class AirForceFragment : Fragment(), AirForceFileAdapter.OnFileClickListener {
    ...
    private lateinit var binding: FragmentAirforceBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = FragmentAirforceBinding.inflate(inflater, container, false)
...
//            Utils.afFilesMap = afFilesMap2
        ...
        requireActivity().onBackPressedDispatcher.addCallback(viewLifecycleOwner) {
            ...
            actionBar?.title = getString(R.string.title_airforce)
        }
    ...
    private fun setupRecyclerView() {
        ...
        binding.listAirForce.layoutManager = LinearLayoutManager(requireContext())
        binding.listAirForce.adapter = adapter
    }
